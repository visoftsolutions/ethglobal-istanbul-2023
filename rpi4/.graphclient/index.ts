...
export type DrinkPriceUpdatedResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["DrinkPriceUpdated"] = ResolversParentTypes["DrinkPriceUpdated"],
> = ResolversObject<{
...
export type DrinkPurchasedResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["DrinkPurchased"] = ResolversParentTypes["DrinkPurchased"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
export type OwnershipTransferredResolvers<
  ContextType = MeshContext,
  ParentType extends
    ResolversParentTypes["OwnershipTransferred"] = ResolversParentTypes["OwnershipTransferred"],
> = ResolversObject<{
  id?: Resolver<ResolversTypes["Bytes"], ParentType, ContextType>;
...
> = ResolversObject<{
  drinkPriceUpdated?: Resolver<
    Maybe<ResolversTypes["DrinkPriceUpdated"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydrinkPriceUpdatedArgs, "id" | "subgraphError">
  >;
  drinkPriceUpdateds?: Resolver<
    Array<ResolversTypes["DrinkPriceUpdated"]>,
    ParentType,
    ContextType,
    RequireFields<
      QuerydrinkPriceUpdatedsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  drinkPurchased?: Resolver<
    Maybe<ResolversTypes["DrinkPurchased"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydrinkPurchasedArgs, "id" | "subgraphError">
  >;
  drinkPurchaseds?: Resolver<
    Array<ResolversTypes["DrinkPurchased"]>,
    ParentType,
    ContextType,
    RequireFields<QuerydrinkPurchasedsArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  drinkPriceUpdated?: SubscriptionResolver<
    Maybe<ResolversTypes["DrinkPriceUpdated"]>,
    "drinkPriceUpdated",
    ParentType,
    ContextType,
    RequireFields<SubscriptiondrinkPriceUpdatedArgs, "id" | "subgraphError">
  >;
  drinkPriceUpdateds?: SubscriptionResolver<
    Array<ResolversTypes["DrinkPriceUpdated"]>,
    "drinkPriceUpdateds",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptiondrinkPriceUpdatedsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
  drinkPurchased?: SubscriptionResolver<
    Maybe<ResolversTypes["DrinkPurchased"]>,
    "drinkPurchased",
    ParentType,
    ContextType,
    RequireFields<SubscriptiondrinkPurchasedArgs, "id" | "subgraphError">
  >;
  drinkPurchaseds?: SubscriptionResolver<
    Array<ResolversTypes["DrinkPurchased"]>,
    "drinkPurchaseds",
    ParentType,
    ContextType,
    RequireFields<
      SubscriptiondrinkPurchasedsArgs,
      "skip" | "first" | "subgraphError"
    >
  >;
